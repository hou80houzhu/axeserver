/*!
 * @packet contenter.edit; 
 * @require contenter.form;
 * @css contenter.style.editor;
...
Module({
    ...
    className: "editor",
    layout: domstr("@formtemplate", "htmleditor"),
    option: {
    ...
    find_textarea: function (dom) {
        ...
        this.paperdoc.open();
        this.paperdoc.writeln("<div id='editor' contentEditable='true' style='margin:0 auto;line-height:1.6;overflow:hidden;width:90%;min-height:900px;background:white;padding:10px;outline:none;border:1px solid #DDDDDD;'><div><br/></div></div><br style='clear:both'/>");
        this.paperdoc.close();
    ...
    event_insertImg: function () {
        ...
        this.addChild({
            ...
            option: {
                ...
                "@form.listform": {
                    fields: [
                        {name: "img", label: "label", type: "@form.imageupload", filename: ths.option.filename, url: basePath + "editor/upload"}
                    ]
                },
                override: {
                    event_save: function (e) {
                        ...
                        this.getChildAt(0).getValues().done(function (data) {
                            ths.doCommand("insertHTML", false, "<img style='width:100%' src='" + data.img + "'/>");
                            thss.close();
                            ths.focus();
                        });
                        e.stopPropagation();
    ...
    getBox: function (option) {
        var a = $($.template(domstr("@formtemplate", "htmleditorbox")).render(option)).appendTo(this.dom);
        this.delegateEvent();
        return a;
    },
    getValue:function(){
    ...
    setValue:function(value){
        this.value=value;
        $(this.editorDiv).html("<div><br>"+value+"</div>");
    },
    check:function(){
...
Module({
    ...
    layout: domstr("@formtemplate", "htmleditorbox"),
    option: {
        title: "",
