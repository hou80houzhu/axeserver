/*!
 * @packet page.form.photo;
 * @require page.util.canvas;
 * @require page.util.file;
 * @css page.style.photocutter;
 * @css page.style.font-awesome-min;
 */
Module({
    name: "photocutter",
    ...
    setImage: function (files) {
        ...
        if (files.length > 0) {
            ...
            filex.getImage(function (ximage) {
                var _w = ximage.width, _h = ximage.height;
