...
Module({
    ...
    layout: domstr("@group", "tablegroup"),
...
Module({
    ...
    event_table_rowdelete: function (e) {
        ...
        if (!control["timeout"]) {
            var b = $("<div class='alert'><div>确定删除？</div></div>").appendTo(btn.parent().parent().parent());
            control["alert"] = b;
            b.click(function (e) {
                clearTimeout(control["timeout"]);
                control["alert"].html("<div><i class='fa fa-refresh fa-spin'></i></div>");
                ths.postData({
                    url: ths.option.tableremove.url,
                    data: {ids: data.id},
                    back: function () {
...
Module({
    ...
    layout: domstr("@group", "selecttable"),
    option: {
        tableType: "@table.doubleTable",
        formType: "@form.listform",
        showName: "name",
...
Module({
    ...
    layout: domstr("@group", "treetablegroup"),
    onbeforeinit: function (option) {
        option[option.tablegroupType] = {
            find: this.option.find,
            table: this.option.table||{}
        };
        option[option.tablegroupType].table["isrefresh"]=false;
...
Module({
    ...
    layout: domstr("@group", "treetabgroup"),
    onbeforeinit: function (option) {
...
Module({
    ...
    layout: domstr("@group", "edittreetablegroup"),
    onbeforeinit: function (option) {
        option[option.tablegroupType] = {
            find: this.option.find,
            table: this.option.table
