    ...
    createpanel: function () {
        if (!this.isdate) {
            ...
            for (var i = 0; i < 6; i++) {
                ...
                for (var j = 0; j < 7; j++) {
                    b += "<div class='datepicker-cell'>" + (j + 1) + "</div>";
                }
                b += "</div>";
            }
            if (this.option.time) {
...
//            });
    ...
    refresh: function () {
        ...
        ct = false;
        this.box.find(".datepicker-row").eq(5).find(".btn").each(function () {
        ...
        ct = false;
        this.box.find(".datepicker-row").eq(6).find(".btn").each(function () {
            if ($(this).css("display") === "block" || $(this).css("display") === "inline-block") {
                ct = true;
                return false;
            }
